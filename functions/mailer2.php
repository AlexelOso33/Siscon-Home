...
<html>
    <head>
        ...
        <title>Siscon® System by AGS - Desarrollo Web</title>
        <style type="text/css">
                        ...
                        <div class="content">
                            <table>
                                <tbody>
                                    <tr>
                                        <td>
                                            <h3 class="title-body" align="center">¡Hola, %nombre%!</h3>
                                            <p class="lead">Estas casi listo para comenzar a usar tu cuenta <a href="https://siscon-system.com" target="_blank">Siscon&reg; %sistema%</a>, solamente necesitamos que confirmes tu correo.</p>
                                            ...
                                            <table class="callout" width="100%">
                                                <tbody>
                                                    <tr>
                                                        <td align="center">
                                                            <p class="callout">
                                                            <a href="%url%" target="_blank">Clic aquí para activar la cuenta</a>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                        ...
                                                        <td>
                                                            <table align="left" class="column">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <p>Si el link presenta alguna dificultad, ingrega aquí <a href="https://hello.siscon-system.com/activate.php">https://hello.siscon-system.com/activate.php</a> e introduce el siguiente código:</p>
                                                                            <p class="number">%activacion%</p>
                                                                            <h5></h5>
                                                                            <p>¡Saludos!</p>
