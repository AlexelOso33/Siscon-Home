...
<body class="login-page">
    ...
    <div class="preloader pre-contract transition-all">
        ...
        <div class="preloader-span" style="display:none;">
            <span>Estamos enviándo tu solicitud. Espera por favor...</span>
        </div>
        ...
        <div class="preloader-a" style="display:none;">
            <a href="https://hello.siscon-system.com" class="pre-btn-back">Volver a INICIO</a>
        </div>
    </div>
                ...
                <div class="contact-form">
                    <form type="POST" role="form" id="registro-siscon">
                        ...
                        <div class="mail-error" style="display:none;">
                            <span class="golden">El email que ingresaste ya se encuentra en nuestro sistema.<br>Puedes <a href="https://siscon-system.com" style="color:#333;">ingresar desde aquí</a> al sistema.<br>Si crees que esto se debe a un error <a href="mailto:contacto@siscon-system.com" style="color:#333;">háznoslo saber aquí</a>.</span>
                        </div>
                        ...
                        <input type="hidden" name="accion" value="enviar-mail-confirm">
